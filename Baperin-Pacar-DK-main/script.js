...
footer.href = "https://www.dkvenz.com/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Ajeng", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        ...
        const {
          ...
          title: 'Masukin nama kamu disini',
          input: 'text',
          inputLabel: '',
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Jahat banget emang ga kangen sama pacar sendiri', '', 'error').then(function () {
                          Swal.fire('Yah kangen banget padahal')
                        })
                      }
                    })
                  })
              ...
              Swal.fire(`Yakin ga suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Yah padahal sayang banget')
              })
            }
          })
        })
